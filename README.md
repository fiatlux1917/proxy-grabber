...
Proxies are well suited for **brute-force**. Supports **http(s)**, **socks(4/5)** protocols. There is detailed information on each proxy, in the flesh along the aisle to popular sites. The proxy check time and location are also displayed. **1 grab ~ 1000 proxies**. Possible duplicates ~ 10-15%. 
